...
public class Person : MonoBehaviour {
    ...
    // ------------------------------------------
    public List<Identifier> GetItemsWorn()
    {
        var wornItems = new List<Identifier>();
        wornItems.Add(_hat.GetComponent<Identifier>());
        wornItems.Add(_face.GetComponent<Identifier>());
        return wornItems;
    }
